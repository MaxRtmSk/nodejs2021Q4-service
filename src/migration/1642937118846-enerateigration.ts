...
export class enerateigration1642937118846 implements MigrationInterface {
    name = 'enerateigration1642937118846'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "tasks" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying NOT NULL, "columns" json NOT NULL, "order" character varying NOT NULL, "description" character varying NOT NULL, "columnId" character varying, "userId" uuid, "boardId" uuid, CONSTRAINT "PK_8d12ff38fcc62aaba2cab748772" PRIMARY KEY ("id"))`);
